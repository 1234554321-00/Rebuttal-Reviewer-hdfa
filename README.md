...
On a system processing 1M anomaly checks/day:
...
Figure 5 (page 23) shows progressive curriculum achieves 2.3× faster convergence (fewer epochs needed: 150 → 100), offsetting checkpoint overhead.
...
4× reduction is consistent across all components due to h'=64 vs h=128 dimensionality.
...
Speedup is consistent across scales (2.3-2.4×), validating Theorem 7's O(h/h') complexity prediction.
